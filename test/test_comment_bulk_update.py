...
class TestCommentBulkUpdate(unittest.TestCase):
    """CommentBulkUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentBulkUpdate:
        """Test CommentBulkUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentBulkUpdate`
        """
        model = CommentBulkUpdate()
        if include_optional:
            return CommentBulkUpdate(
                id = '',
    ...
    def testCommentBulkUpdate(self):
        """Test CommentBulkUpdate"""
