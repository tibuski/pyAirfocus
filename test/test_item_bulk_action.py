...
class TestItemBulkAction(unittest.TestCase):
    """ItemBulkAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemBulkAction:
        """Test ItemBulkAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemBulkAction`
        """
        model = ItemBulkAction()
        if include_optional:
            return ItemBulkAction(
