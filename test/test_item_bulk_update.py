...
class TestItemBulkUpdate(unittest.TestCase):
    """ItemBulkUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemBulkUpdate:
        """Test ItemBulkUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemBulkUpdate`
        """
        model = ItemBulkUpdate()
        if include_optional:
            return ItemBulkUpdate(
                id = '',
