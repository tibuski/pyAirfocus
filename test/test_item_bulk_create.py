...
class TestItemBulkCreate(unittest.TestCase):
    """ItemBulkCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemBulkCreate:
        """Test ItemBulkCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemBulkCreate`
        """
        model = ItemBulkCreate()
        if include_optional:
            return ItemBulkCreate(
                resource = openapi_client.models.item.Item(
                    archived = True, 
                    assignee_user_ids = [
                        ''
                        ], 
