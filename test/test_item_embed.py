...
class TestItemEmbed(unittest.TestCase):
    """ItemEmbed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemEmbed:
        """Test ItemEmbed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemEmbed`
        """
        model = ItemEmbed()
        if include_optional:
            return ItemEmbed(
