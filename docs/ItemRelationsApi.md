# openapi_client.ItemRelationsApi

All URIs are relative to *https://app.airfocus.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**bulk_item_relations**](ItemRelationsApi.md#bulk_item_relations) | **POST** /api/workspaces/item-relations/bulk | Perform multiple operations with item relations
[**create_item_relation**](ItemRelationsApi.md#create_item_relation) | **POST** /api/workspaces/item-relations | Create a new item relation
[**delete_item_relation**](ItemRelationsApi.md#delete_item_relation) | **DELETE** /api/workspaces/item-relations/{itemRelationId} | Delete an existing item relation
[**list_item_relations**](ItemRelationsApi.md#list_item_relations) | **POST** /api/workspaces/item-relations/list | Retrieve multiple item relations by their IDs
[**patch_item_relation**](ItemRelationsApi.md#patch_item_relation) | **PATCH** /api/workspaces/item-relations/{itemRelationId} | Patch an existing item relation
[**retrieve_item_relation**](ItemRelationsApi.md#retrieve_item_relation) | **GET** /api/workspaces/item-relations/{itemRelationId} | Retrieve a single item relation by its ID
[**search_item_relations**](ItemRelationsApi.md#search_item_relations) | **POST** /api/workspaces/item-relations/search | Retrieve or search item relations
[**update_item_relation**](ItemRelationsApi.md#update_item_relation) | **PUT** /api/workspaces/item-relations/{itemRelationId} | Update an existing item relation
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ItemRelationsApi(api_client)
    ...
    try:
        ...
        print("The response of ItemRelationsApi->bulk_item_relations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->bulk_item_relations: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ItemRelationsApi->create_item_relation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->create_item_relation: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ItemRelationsApi->delete_item_relation: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ItemRelationsApi->list_item_relations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->list_item_relations: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ItemRelationsApi->patch_item_relation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->patch_item_relation: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ItemRelationsApi->retrieve_item_relation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->retrieve_item_relation: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ItemRelationsApi->search_item_relations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->search_item_relations: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ItemRelationsApi->update_item_relation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemRelationsApi->update_item_relation: %s\n" % e)
```
