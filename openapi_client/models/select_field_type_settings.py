...
class SelectFieldTypeSettings(BaseModel):
    """
    SelectFieldTypeSettings
    """ # noqa: E501
    multi: StrictBool
    options: Optional[List[SelectFieldTypeOption]] = None
    __properties: ClassVar[List[str]] = ["multi", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "multi": obj.get("multi"),
            "options": [SelectFieldTypeOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
