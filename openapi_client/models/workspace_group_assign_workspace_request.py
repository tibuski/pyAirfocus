...
class WorkspaceGroupAssignWorkspaceRequest(BaseModel):
    """
    WorkspaceGroupAssignWorkspaceRequest
    """ # noqa: E501
    workspace_group_id: Optional[StrictStr] = Field(default=None, alias="workspaceGroupId")
    workspace_id: StrictStr = Field(alias="workspaceId")
    __properties: ClassVar[List[str]] = ["workspaceGroupId", "workspaceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspaceGroupId": obj.get("workspaceGroupId"),
