...
class WorkspaceServerEndpointsSetStatusesRequest(BaseModel):
    """
    ...
    statuses: Optional[List[WorkspaceServerEndpointsSetStatusesRequestStatusesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [WorkspaceServerEndpointsSetStatusesRequestStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
