...
class TemplatePageWithEmbed(BaseModel):
    """
    TemplatePageWithEmbed
    """ # noqa: E501
    embedded: TemplateSearchEmbed = Field(alias="_embedded")
    items: Optional[List[Template]] = None
    total_items: StrictInt = Field(alias="totalItems")
    __properties: ClassVar[List[str]] = ["_embedded", "items", "totalItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_embedded": TemplateSearchEmbed.from_dict(obj["_embedded"]) if obj.get("_embedded") is not None else None,
