...
class ItemSearchQueryFilterLastUpdatedAt(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mode", "property", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": ItemSearchQueryDateTimeFilterValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
