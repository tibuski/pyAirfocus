...
class FieldFieldWorkspaceEmbed(BaseModel):
    """
    FieldFieldWorkspaceEmbed
    """ # noqa: E501
    order: StrictInt = Field(description="Order of the field in this specific workspace.")
    workspace_id: StrictStr = Field(alias="workspaceId")
    __properties: ClassVar[List[str]] = ["order", "workspaceId"]
