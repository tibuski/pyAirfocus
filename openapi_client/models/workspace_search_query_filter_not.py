...
class WorkspaceSearchQueryFilterNot(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inner": WorkspaceSearchQueryFilter.from_dict(obj["inner"]) if obj.get("inner") is not None else None
        })
        return _obj

from openapi_client.models.workspace_search_query_filter import WorkspaceSearchQueryFilter
# TODO: Rewrite to not use raise_errors
WorkspaceSearchQueryFilterNot.model_rebuild(raise_errors=False)
