...
class ItemSearchQueryFilterStatusContainsAny(BaseModel):
    """
    ItemSearchQueryFilterStatusContainsAny
    """ # noqa: E501
    status_ids: Optional[List[StrictStr]] = Field(default=None, alias="statusIds")
    __properties: ClassVar[List[str]] = ["statusIds"]
