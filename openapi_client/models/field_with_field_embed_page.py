...
class FieldWithFieldEmbedPage(BaseModel):
    """
    FieldWithFieldEmbedPage
    """ # noqa: E501
    items: Optional[List[FieldWithFieldEmbed]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FieldWithFieldEmbed.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
