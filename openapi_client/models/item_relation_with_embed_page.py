...
class ItemRelationWithEmbedPage(BaseModel):
    """
    ItemRelationWithEmbedPage
    """ # noqa: E501
    items: Optional[List[ItemRelationWithEmbed]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ItemRelationWithEmbed.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
