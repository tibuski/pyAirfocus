...
class WorkspaceRelationSearchQueryFilterNot(BaseModel):
    """
    WorkspaceRelationSearchQueryFilterNot
    """ # noqa: E501
    inner: WorkspaceRelationSearchQueryFilter
    __properties: ClassVar[List[str]] = ["inner"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of inner
        if self.inner:
            _dict['inner'] = self.inner.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inner": WorkspaceRelationSearchQueryFilter.from_dict(obj["inner"]) if obj.get("inner") is not None else None
        })
        return _obj

from openapi_client.models.workspace_relation_search_query_filter import WorkspaceRelationSearchQueryFilter
# TODO: Rewrite to not use raise_errors
WorkspaceRelationSearchQueryFilterNot.model_rebuild(raise_errors=False)
