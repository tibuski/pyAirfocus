...
class FieldEmbed(BaseModel):
    """
    FieldEmbed
    """ # noqa: E501
    workspaces: Optional[List[FieldFieldWorkspaceEmbed]] = Field(default=None, description="List of all workspaces where this field is used.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspaces": [FieldFieldWorkspaceEmbed.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None
        })
        return _obj
