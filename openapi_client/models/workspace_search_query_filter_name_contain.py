...
class WorkspaceSearchQueryFilterNameContain(BaseModel):
    """
    WorkspaceSearchQueryFilterNameContain
    """ # noqa: E501
    case_sensitive: StrictBool = Field(alias="caseSensitive")
    text: StrictStr
    __properties: ClassVar[List[str]] = ["caseSensitive", "text"]
