...
class RichTextBlockPanel(BaseModel):
    """
    RichTextBlockPanel
    """ # noqa: E501
    color_hex: StrictStr = Field(alias="colorHex")
    content: RichTextBlock
    __properties: ClassVar[List[str]] = ["colorHex", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": RichTextBlock.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj

from openapi_client.models.rich_text_block import RichTextBlock
# TODO: Rewrite to not use raise_errors
RichTextBlockPanel.model_rebuild(raise_errors=False)
