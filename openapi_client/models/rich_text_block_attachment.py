...
class RichTextBlockAttachment(BaseModel):
    """
    RichTextBlockAttachment
    """ # noqa: E501
    attachment_id: StrictStr = Field(alias="attachmentId")
    caption: Optional[StrictStr] = None
    content_type: StrictStr = Field(alias="contentType")
    width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["attachmentId", "caption", "contentType", "width"]
