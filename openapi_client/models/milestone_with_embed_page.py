...
class MilestoneWithEmbedPage(BaseModel):
    """
    MilestoneWithEmbedPage
    """ # noqa: E501
    items: Optional[List[MilestoneWithEmbed]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [MilestoneWithEmbed.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
