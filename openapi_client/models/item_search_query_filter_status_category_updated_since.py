...
class ItemSearchQueryFilterStatusCategoryUpdatedSince(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": ItemSearchQueryTimeAnchor.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
