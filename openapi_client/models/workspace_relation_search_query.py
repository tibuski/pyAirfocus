...
class WorkspaceRelationSearchQuery(BaseModel):
    """
    WorkspaceRelationSearchQuery
    """ # noqa: E501
    filter: Optional[WorkspaceRelationSearchQueryFilter] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": WorkspaceRelationSearchQueryFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None
        })
        return _obj
