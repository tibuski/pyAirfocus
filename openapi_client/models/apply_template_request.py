...
class ApplyTemplateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["defaultPermission", "groupId", "name", "parameters", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "parameters": TemplateParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None,
