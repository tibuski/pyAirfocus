...
class TimePeriodFieldSettingsIterations(BaseModel):
    """
    TimePeriodFieldSettingsIterations
    """ # noqa: E501
    current_id: StrictStr = Field(alias="currentId")
    multi: StrictBool
    time_periods: Optional[List[TimePeriod]] = Field(default=None, alias="timePeriods")
    __properties: ClassVar[List[str]] = ["currentId", "multi", "timePeriods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentId": obj.get("currentId"),
            "multi": obj.get("multi"),
            "timePeriods": [TimePeriod.from_dict(_item) for _item in obj["timePeriods"]] if obj.get("timePeriods") is not None else None
        })
        return _obj
