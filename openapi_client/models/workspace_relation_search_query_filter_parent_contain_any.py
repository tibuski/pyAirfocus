...
class WorkspaceRelationSearchQueryFilterParentContainAny(BaseModel):
    """
    WorkspaceRelationSearchQueryFilterParentContainAny
    """ # noqa: E501
    workspace_ids: Optional[List[StrictStr]] = Field(default=None, alias="workspaceIds")
    __properties: ClassVar[List[str]] = ["workspaceIds"]
