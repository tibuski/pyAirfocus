...
class OkrKeyResultReferenceFieldWithFieldEmbed(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_embedded", "createdAt", "description", "id", "isTeamField", "name", "teamId", "typeId"]
