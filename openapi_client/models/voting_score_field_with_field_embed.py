...
class VotingScoreFieldWithFieldEmbed(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "settings": VotingAppScoreFieldTypeSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
